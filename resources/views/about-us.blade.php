            ...
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <div class="bg-[var(--bg)] rounded-lg shadow-lg p-10 card">
                    ...
                    <p class="mt-4 text-lg leading-relaxed">
                        ...
                        you need for academic life into one place — from tech and textbooks to fashion 
                        and home living.
                    </p>
                </div>
            </div>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div class="bg-[var(--card)] text-[var(--text)] shadow-lg rounded-lg p-8 card">
                        ...
                        <ul class="mt-4 space-y-2">
                            ...
                            <li>Trousers & jackets</li>
                            <li>Undergarments & shoes</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[var(--card)] text-[var(--text)] shadow-lg rounded-lg p-8 card">
                        ...
                        <ul class="mt-4 space-y-2">
                            ...
                            <li>Pens, notebooks & textbooks</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[var(--card)] text-[var(--text)] shadow-lg rounded-lg p-8 card">
                        ...
                        <ul class="mt-4 space-y-2">
                            <li>Bedding & decor</li>
                            <li>Kitchenware & dining</li>
                            <li>Cooking & cleaning essentials</li>
                        </ul>
                    </div>
            ...
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <div class="bg-[var(--bg)] rounded-lg shadow-lg p-10 card">
                    ...
                    <p class="mt-4 text-lg leading-relaxed">
                        ...
                        life easier, smarter, and more affordable — all in one place.
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                <div class="bg-[var(--bg)] rounded-lg shadow-lg p-10 card">
                    ...
                    <p class="mt-4 text-lg leading-relaxed">
                        ...
                        convenience, affordability, and trust. We help you spend less, save more, 
