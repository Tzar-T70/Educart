        ...
        <!-- Hero Section -->
         <div class=" bg-brand-beige ">            
            <div class="max-w-7xl mx-auto">
                ...
                <div class="relative z-10 pb-8 bg-brand-beige sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-16 xl:pb-20">                    <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-brand-beige transform translate-x-1/2" fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
