...
<div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition group bg-white flex flex-col h-full">
    ...
    <a href="{{ route('products.show', $product) }}" class="block w-full h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
    ...
    <div class="p-4 flex flex-col flex-grow">
        ...
        <div class="mt-auto flex justify-between items-center pt-2">
            ...
            <form action="{{ route('basket.add') }}" method="POST">
                ...
                <button type="submit" class="text-sm bg-brand-dark-blue text-white px-3 py-1 rounded hover:bg-opacity-90 transition shadow-sm">
                    Add to Cart
                </button>
            </form>
        </div>
